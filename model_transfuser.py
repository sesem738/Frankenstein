...
class GPT(nn.Module):
    ...
    def forward(self, image_tensor):
        ...
        image_tensor = image_tensor.view(bz, self.config.n_views * self.seq_len, -1)
        ...
        image_tensor_out = x[:, :self.config.n_views*self.seq_len, :, :, :].contiguous().view(bz * self.config.n_views * self.seq_len, -1)
