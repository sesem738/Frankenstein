...
class SAC(object):
    ...
    def update_parameters(self, memory, batch_size, his_len, updates):
        # Sample a batch from memory
        state_batch, action_batch, next_state_batch, reward_batch, mask_batch = memory.prior_samples(batch_size, his_len)
